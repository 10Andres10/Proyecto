...
def boton_aceptar():
    ...
    Label1v2 = Label(ventana2,text=" \n Selecciona tu \n \n rango de edad \n")
    Label1v2.config(fg="gray30", bg="cadetblue1", font=("Comic Sans MS",12))
    Label1v2.place(x=150,y=30)

    #img = tk.PhotoImage(file="img.gif")
    #Label1v2 = Label(ventana2,image=img)
    #Label1v2.place(x=500,y=500)
    ...
    def edad_3_a_5_años():
        ...
        ventana3.config(bg="cadetblue1")
        ventana3.resizable(0,0)

        Frame = Label(ventana3)
        Frame.config(bg="OrangeRed3")
        Frame.place(x=20,y=20,width=960,height=610)
        
        alimentacion = Label(Frame, text="\nAlimentación\n")
        alimentacion.config(bg="OrangeRed3",fg="Black", font=("Comic Sans MS",14))
        alimentacion.place(x=20,y=20,width=900,height=500)
        
        texto_niños= Label(Frame, text= "\nDebes incluir en tus comidas leche y productos lácteos,\n \npara satisfacer las necesidades de calcio de tus huesos\n \nen crecimiento. Limita el consumo de jugos y bebidas\n \nendulzadas, en su lugar, incrementa en tus comidas\n \nfrutas y alimentos a base de granos, como sándwiches o\n \ngalletas como refrigerios.\n")
        texto_niños.config(bg="OrangeRed3",fg="Black", font=("Comic Sans MS",12))
        texto_niños.place(x=20,y=20,width=900,height=500)
    ...
    boton_niños12_19.place(x=30,y=150, width=100,height=40)
    ...
    boton_niños20_26.place(x=30,y=210, width=100,height=40)
